...
export class DeliveryComponent implements OnInit {
 ...
 public frais:number;
  ...
  constructor(private deliveryService:DeliveryService,private https : HttpClient) { 
    this.deliveries=[];
    this.frais=0;
...
getfrais( deliveryId : number){


  return this.https.get<number>("http://localhost:8092/SpringMVC/servlet/frais/"+ deliveryId).subscribe(res=>{
    this.frais = res;
